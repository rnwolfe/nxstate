...
nxstate is a Python package on [PyPI](https://pypi.org/project/nxstate/). Pick whichever fits your workflow — `uvx` is the fastest way to start.
...
Prefer to grab the artifacts directly? Every tagged version ships a wheel and sdist on the [GitHub Releases page](https://github.com/rnwolfe/nxstate/releases).
